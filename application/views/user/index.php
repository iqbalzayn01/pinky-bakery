    ...
    <div class="row text-center">
        ...
        <div class="card ml-1 mr-3 mb-4" style="width: 15rem;  ">
            ...
            <div class="card-body">
                ...
                <?php
                    if ($pdk->stok < 1) {
                    echo "<i class='btn btn-sm btn-primary'> Cart&nbsp;&nbsp0</i>";
                    } else {
                    echo "<a class='btn btn-sm btn-primary' href='" . base_url('pemesanan/addProduct/' . $pdk->id) . "'>Cart</a>";
                    }
                ?>
                <!-- <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newProductModal">Add to
                    Cart</a> -->
            </div>
        </div>
        <?php endforeach; ?>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="kuantitas" name="kuantitas"
                            placeholder="Kuantitas" value="<?= set_value('kuantitas'); ?>">
